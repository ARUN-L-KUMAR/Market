    ...
    <div className="min-h-screen bg-slate-50 pt-20">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        >
          ...
          <p className="text-xl text-slate-600 leading-relaxed">Manage your shipping and billing addresses</p>
        ...
        {!showForm && (
          ...
          >
            <Button
              ...
              className="bg-indigo-600 hover:bg-indigo-700 text-white shadow-sm hover:shadow-sm transform hover:scale-105 transition-all duration-200"
            >
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-slate-800">Saved Addresses</h2>

          {addresses.length === 0 ? (
            <div className="bg-white rounded-lg shadow-subtle border border-slate-200 p-8 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {addresses.map((address) => (
                <div
                  key={address._id}
                  className={`bg-white rounded-lg shadow-subtle border p-6 ${address.isDefault ? 'border-indigo-300 bg-indigo-50' : 'border-slate-200'
                    }`}
                >
                  {/* Address Header */}
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-medium capitalize px-2 py-1 bg-slate-100 text-slate-700 rounded">
                        {address.type}
                      </span>
                      {address.isDefault && (
