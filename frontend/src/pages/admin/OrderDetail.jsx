                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-4 flex-1">
                        <div className="flex justify-between">
                          ...
                          <p className="text-sm font-medium text-slate-900">${((item.price || 0) * (item.quantity || 0)).toFixed(2)}</p>
                        </div>
              ...
              <div className="px-4 py-5 sm:px-6 border-t border-slate-200">
                <dl className="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
                  <div className="sm:col-span-1">
                    ...
                    <dd className="mt-1 text-sm text-slate-900">${(order.subtotal || 0).toFixed(2)}</dd>
                  </div>
                  <div className="sm:col-span-1">
                    <dt className="text-sm font-medium text-slate-500">Shipping</dt>
                    <dd className="mt-1 text-sm text-slate-900">${(order.shippingCost || 0).toFixed(2)}</dd>
                  </div>
                  <div className="sm:col-span-1">
                    <dt className="text-sm font-medium text-slate-500">Tax</dt>
                    <dd className="mt-1 text-sm text-slate-900">${(order.tax || 0).toFixed(2)}</dd>
                  </div>
                  <div className="sm:col-span-1">
                    <dt className="text-sm font-medium text-slate-500">Discount</dt>
                    <dd className="mt-1 text-sm text-slate-900">${(order.discount || 0).toFixed(2)}</dd>
                  </div>
                  <div className="sm:col-span-2 border-t pt-4">
                    <dt className="text-base font-semibold text-slate-900">Total</dt>
                    <dd className="mt-1 text-base font-semibold text-slate-900">${(order.total || 0).toFixed(2)}</dd>
                  </div>
                </dl>
              </div>
            </div>
