  ...
  return (
    <AdminLayout>
      <div className="p-6">
        ...
        {success && (
          <div className="bg-emerald-100 border border-green-400 text-emerald-700 px-4 py-3 rounded mb-4">
            {success}
          </div>
        )}
          ...
          <nav className="-mb-px flex space-x-8">
            {tabs.map(tab => (
              <button
                ...
                className={`whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm ${activeTab === tab.id ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-slate-500 hover:text-slate-700 hover:border-slate-300'}`}
              >
                {tab.label}
              </button>
            ))}
              ...
              <div className="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                <div className="md:grid md:grid-cols-3 md:gap-6">
                  <div className="md:col-span-1">
                    <h3 className="text-lg font-medium leading-6 text-slate-900">Store Information</h3>
                  ...
                  <div className="mt-5 md:mt-0 md:col-span-2">
                    <div className="grid grid-cols-6 gap-6">
                      ...
                      <div className="col-span-6 sm:col-span-4">
                        <label htmlFor="storeEmail" className="block text-sm font-medium text-slate-700">Email Address</label>
                        <input
                          type="email"
                          name="storeEmail"
                          id="storeEmail"
                      ...
                      <div className="col-span-6 sm:col-span-4">
                        <label htmlFor="storePhone" className="block text-sm font-medium text-slate-700">Phone Number</label>
                        <input
                          type="text"
                          name="storePhone"
                          id="storePhone"
                      ...
                      <div className="col-span-6">
                        <label htmlFor="storeAddress" className="block text-sm font-medium text-slate-700">Address</label>
                        <textarea
                          name="storeAddress"
                          id="storeAddress"
                          rows="3"
          ...
          {activeTab === 'shipping' && (
            <div className="space-y-6">
              <div className="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                <div className="md:grid md:grid-cols-3 md:gap-6">
                  <div className="md:col-span-1">
                    <h3 className="text-lg font-medium leading-6 text-slate-900">Shipping & Tax</h3>
                    <p className="mt-1 text-sm text-slate-500">
                  ...
                  <div className="mt-5 md:mt-0 md:col-span-2">
                    <div className="grid grid-cols-6 gap-6">
                      <div className="col-span-6 sm:col-span-3">
                        <label htmlFor="taxRate" className="block text-sm font-medium text-slate-700">Tax Rate (%)</label>
                        <input
                          type="number"
                          name="taxRate"
                          id="taxRate"
                      ...
                      <div className="col-span-6 sm:col-span-3">
                        <label htmlFor="shippingFee" className="block text-sm font-medium text-slate-700">Default Shipping Fee</label>
                      ...
                      <div className="col-span-6 sm:col-span-4">
                        <label htmlFor="freeShippingThreshold" className="block text-sm font-medium text-slate-700">Free Shipping Threshold</label>
                        <div className="mt-1 relative rounded-md shadow-sm">
                          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <span className="text-slate-500 sm:text-sm">
                              {settings.currency === 'USD' ? '$' : settings.currency + ' '}
                          ...
                          <input
                            ...
                            className="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-7 sm:text-sm border-slate-300 rounded-md"
                          />
                          <div className="mt-1 text-sm text-slate-500">Set to 0 to disable free shipping</div>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          {activeTab === 'features' && (
            <div className="space-y-6">
              <div className="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                <div className="md:grid md:grid-cols-3 md:gap-6">
                  <div className="md:col-span-1">
                    <h3 className="text-lg font-medium leading-6 text-slate-900">Features</h3>
                    <p className="mt-1 text-sm text-slate-500">
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                          <label htmlFor="enableGuestCheckout" className="font-medium text-slate-700">Enable Guest Checkout</label>
                          <p className="text-slate-500">Allow customers to checkout without creating an account.</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                          <label htmlFor="enableReviews" className="font-medium text-slate-700">Enable Product Reviews</label>
                          <p className="text-slate-500">Allow customers to leave reviews on products.</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                          <label htmlFor="enableWishlist" className="font-medium text-slate-700">Enable Wishlist</label>
                          <p className="text-slate-500">Allow customers to save products to a wishlist.</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                          <label htmlFor="enableRealTimeUpdates" className="font-medium text-slate-700">Enable Real-time Updates</label>
                          <p className="text-slate-500">Show real-time inventory and order updates to customers.</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                          <label htmlFor="maintenanceMode" className="font-medium text-slate-700">Maintenance Mode</label>
                          <p className="text-slate-500">Put the store in maintenance mode. Only admins can access the site.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="col-span-6">
                        ...
                        <div className="mt-1 flex items-center">
                          {settings.logo ? (
                            ...
                            <div className="mr-4 flex items-center justify-center h-12 w-12 rounded-md bg-slate-100 text-slate-300">
                          ...
                          <input
                            ...
                            value={settings.logo}
                            onChange={handleChange}
                            className="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm border-slate-300"
                      ...
                      <div className="col-span-6">
                        ...
                        <div className="mt-1 flex items-center">
                          {settings.favicon ? (
                            ...
                            <div className="mr-4 flex items-center justify-center h-8 w-8 rounded-md bg-slate-100 text-slate-300">
          ...
          {activeTab === 'social' && (
            <div className="space-y-6">
              <div className="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                <div className="md:grid md:grid-cols-3 md:gap-6">
                  <div className="md:col-span-1">
                    <h3 className="text-lg font-medium leading-6 text-slate-900">Social Media</h3>
                    <p className="mt-1 text-sm text-slate-500">
                  ...
                  <div className="mt-5 md:mt-0 md:col-span-2">
                    <div className="grid grid-cols-6 gap-6">
                      <div className="col-span-6 sm:col-span-4">
                        <label htmlFor="socialLinks.facebook" className="block text-sm font-medium text-slate-700">
                          <span className="flex items-center">
                            <svg className="h-5 w-5 mr-2 text-indigo-600" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="col-span-6 sm:col-span-4">
                        <label htmlFor="socialLinks.twitter" className="block text-sm font-medium text-slate-700">
                          <span className="flex items-center">
                            <svg className="h-5 w-5 mr-2 text-indigo-400" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="col-span-6 sm:col-span-4">
                        <label htmlFor="socialLinks.instagram" className="block text-sm font-medium text-slate-700">
                          <span className="flex items-center">
                      ...
                      <div className="col-span-6 sm:col-span-4">
                        <label htmlFor="socialLinks.youtube" className="block text-sm font-medium text-slate-700">
                          <span className="flex items-center">
