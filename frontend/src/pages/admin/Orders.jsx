    ...
    <AdminLayout>
      <div className="p-6">
        ...
        <div className="mb-6 flex flex-wrap gap-4">
          ...
          <div>
            <label htmlFor="date-filter" className="block text-sm font-medium text-slate-700 mb-1">Date Range</label>
            <select
              id="date-filter"
              className="block w-full pl-3 pr-10 py-2 text-base border-slate-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md"
              value={dateFilter}
                    ...
                    <div className="mt-2">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <button
                          ...
                          className={`py-2 px-4 rounded-md text-sm font-medium ${updateModal.status === 'completed' ? 'bg-emerald-100 text-emerald-700 border-2 border-green-300' : 'bg-slate-100 hover:bg-emerald-50 text-slate-800'}`}
                        >
                          Completed
                        </button>
                        <button
